 ...
 * Further modified by Chaohai Ding
 */
(function (AtKit) {
    ...
    jQ.extend(jQ.facebox, {
        settings: {
            ...
            faceboxHtml: '\
            <div id="at-facebox" style="' + default_css + ' font-family: Helvetica Neue,Helvetica,Arial,sans-serif; font-size:initial; display:none; position: absolute; top:0; z-index:2147483647; direction:left; text-align:left; width:40%"> \
                <div class="at-popup" style="' + default_css + ' position:relative;"> \
                    <table style="' + default_css + ' border-collapse:collapse; border:none"> \
                        <tbody> \
                            <tr> \
                                <td class="at-fb-tl" style="' + default_css + ' background:url(' + baseURL + ((AtKit.getLanguage() == 'ar') ? 'tr' : 'tl') + '.png); border:0 none; border-bottom:0; padding:0; height:10px; width:10px; overflow:hidden; padding:0;" /><td class="at-fb-b" style="' + default_css + ' background:url(' + baseURL + 'b.png); border:0 none; border-bottom:0; padding:0;" /><td class="at-fb-tr" style="' + default_css + ' background:url(' + baseURL + ((AtKit.getLanguage() == 'ar') ? 'tl' : 'tr') + '.png); border:0 none; height10px; width:10px; overflow:hidden ;padding:0;" /> \
                            </tr> \
                            <tr> \
                                <td class="at-fb-b" style="' + default_css + ' background:url(' + baseURL + 'b.png); border:0 none; border-bottom:0 ;padding:0;" /> \
                                <td class="at-fb-tb-body" style="' + default_css + ' border-bottom:0; padding:10px; background:#fff; width:370px;"> \
                                    <div class="at-fb-content"> \
                                    </div> \
                                    <div class="at-fb-footer" style="' + default_css + ' border-top:1px solid #DDDDDD; padding-top:5px; margin-top:10px; direction:rtl; text-align:right"> \
                                        <a href="#" class="at-fb-close"> \
                            ...
                            <tr> \
                                <td class="at-fb-bl" style="' + default_css + ' background:url(' + baseURL + ((AtKit.getLanguage() == 'ar') ? 'br' : 'bl') + '.png); border:0 none; border-bottom:0; padding:0; height:10px; width:10px; overflow:hidden; padding:0;" /><td class="at-fb-b" style="' + default_css + ' background:url(' + baseURL + 'b.png); border:0 none; border-bottom:0; padding:0;" /><td class="at-fb-br" style="' + default_css + ' background:url(' + baseURL + ((AtKit.getLanguage() == 'ar') ? 'bl' : 'br') + '.png); border:0 none; border-bottom:0; padding:0; height:10px; width:10px; overflow:hidden; padding:0;" /> \
                            </tr> \
                        </tbody> \
                    </table> \
                </div> \
        ...
        loading: function () {
            ...
            //avoid conflict class close with other website
            jQ('#at-facebox .at-fb-close').hover(function () {
                jQ(this).css({
    ...
    function init(settings) {
        ...
        jQ('#at-facebox .at-fb-close').click(jQ.facebox.close)
